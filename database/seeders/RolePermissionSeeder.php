...
class RolePermissionSeeder extends Seeder
{
    private const DEFAULTS = [
        'tester' => ['dashboard.view', 'companies.view', 'companies.create', 'companies.update', 'companies.delete', 'contacts.view', 'contacts.create', 'contacts.update', 'contacts.delete', 'leads.view', 'leads.create', 'leads.update', 'leads.delete', 'opportunities.view', 'opportunities.create', 'opportunities.update', 'opportunities.delete', 'activities.view', 'activities.create', 'activities.update', 'activities.delete', 'tasks.view', 'tasks.create', 'tasks.update', 'tasks.delete', 'campaigns.view', 'campaigns.create', 'campaigns.update', 'campaigns.delete', 'reports.view', 'imports.view', 'imports.create', 'imports.update', 'imports.delete'],
        ...
        'marketing' => ['dashboard.view', 'companies.view', 'contacts.view', 'leads.view', 'campaigns.view', 'campaigns.create', 'campaigns.update', 'campaigns.delete', 'imports.view', 'imports.create', 'imports.update', 'reports.view'],
