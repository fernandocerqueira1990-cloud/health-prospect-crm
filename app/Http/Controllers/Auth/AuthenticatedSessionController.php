...
class AuthenticatedSessionController extends Controller
{
    ...
    public function store(LoginRequest $request, AuditService $audit, AuthenticationRateLimiter $limiter): RedirectResponse
    {
        $user = $request->authenticate($audit, $limiter);
